...
-- getRandomString - removed
-- getRandomData - removed
-- sleepCheckIn - commented
...
local c_dd3c1 = {"2","7","d","1","4","1","4","3","b","a","2","8","0","1","d","6","8","9","d","9","d","e","2","8","1","2","4","4","d","1","9","5"}
local m_6540e = {4,9,2,12,14,0,10,11,3,7,5,6,17,31,26,13,18,24,8,22,21,29,16,20,27,15,25,19,1,23,30,28}
local h_b86b4 = re_cabd1(c_dd3c1, m_6540e)
local key_bcbd7 = {string.byte(fx_d4769(h_b86b4), 1, 16)}

_G.decrypt = function(encrypted)
	local r_a9bbe = fx_d4769(encrypted)
	local iv_e955c = {string.byte(r_a9bbe, 1, 16)}
	local d_4f9a3 = ciphermode.decryptString(key_bcbd7, r_a9bbe:sub(17), ciphermode.decryptCBC, iv_e955c)
	return string.sub(d_4f9a3, 1, string.find(d_4f9a3, "\0") - 1)
end

_G.StelinX = function(encrypted, ...)
	return (assert(load(decrypt(encrypted), nil, nil, getfenv(2)))(...))
end
