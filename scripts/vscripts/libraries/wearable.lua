...
_G.DefaultPrismatic = {
    ["5957"] = "unusual_terrorblade_abysm",
    ["6879"] = "unusual_techies_swine"
}

_G.EtherealParticles = {
    Attrib_Particle4 = "particles/econ/courier/courier_selfmade/courier_selfmade.vpcf",
    Attrib_Particle15 = "particles/econ/courier/courier_trail_01/courier_trail_01.vpcf",
    Attrib_Particle16 = "particles/econ/courier/courier_trail_02/courier_trail_02.vpcf",
    Attrib_Particle17 = "particles/econ/courier/courier_eye_glow_01/courier_eye_glow_01.vpcf",
    Attrib_Particle18 = "particles/econ/courier/courier_eye_glow_02/courier_eye_glow_02.vpcf",
    Attrib_Particle19 = "particles/econ/courier/courier_eye_glow_03/courier_eye_glow_03.vpcf",
    Attrib_Particle20 = "particles/econ/courier/courier_eye_glow_04/courier_eye_glow_04.vpcf",
    Attrib_Particle21 = "particles/econ/courier/courier_trail_03/courier_trail_03.vpcf",
    Attrib_Particle22 = "particles/econ/courier/courier_trail_04/courier_trail_04.vpcf",
    Attrib_Particle31 = "particles/econ/courier/courier_eye_glow_defense_01/courier_eye_glow_defense_01.vpcf",
    Attrib_Particle32 = "particles/econ/courier/courier_trail_05/courier_trail_05.vpcf",
    Attrib_Particle37 = "particles/econ/courier/courier_trail_int_2012/courier_trail_international_2012.vpcf",
    Attrib_Particle46 = "particles/econ/courier/courier_trail_hw_2012/courier_trail_hw_2012.vpcf",
    Attrib_Particle47 = "particles/econ/courier/courier_golden_roshan/golden_roshan_ambient.vpcf",
    Attrib_Particle57 = "particles/econ/courier/courier_trail_winter_2012/courier_trail_winter_2012.vpcf",
    Attrib_Particle61 = "particles/econ/courier/courier_trail_blossoms/courier_trail_blossoms.vpcf",
    Attrib_Particle68 = "particles/econ/courier/courier_crystal_rift/courier_ambient_crystal_rift.vpcf",
    Attrib_Particle73 = "particles/econ/courier/courier_trail_cursed/courier_cursed_ambient.vpcf",
    Attrib_Particle74 = "particles/econ/courier/courier_trail_divine/courier_divine_ambient.vpcf",
    Attrib_Particle76 = "particles/econ/courier/courier_trail_fungal/courier_trail_fungal.vpcf",
    Attrib_Particle96 = "particles/econ/courier/courier_trail_lava/courier_trail_lava.vpcf",
    Attrib_Particle109 = "particles/econ/courier/courier_trail_international_2013/courier_international_2013.vpcf",
    Attrib_Particle129 = "particles/econ/courier/courier_trail_ruby/courier_trail_ruby.vpcf",
    Attrib_Particle138 = "particles/econ/courier/courier_polycount_01/courier_trail_polycount_01.vpcf",
    Attrib_Particle156 = "particles/econ/courier/courier_trail_ember/courier_trail_ember.vpcf",
    Attrib_Particle157 = "particles/econ/courier/courier_trail_earth/courier_trail_earth.vpcf",
    Attrib_Particle158 = "particles/econ/courier/courier_trail_orbit/courier_trail_orbit.vpcf",
    Attrib_Particle159 = "particles/econ/courier/courier_trail_spirit/courier_trail_spirit.vpcf",
    Attrib_Particle155 = "particles/econ/courier/courier_trail_hw_2013/courier_trail_hw_2013.vpcf",
    Attrib_Particle163 = "particles/econ/courier/courier_platinum_roshan/platinum_roshan_ambient.vpcf",
    Attrib_Particle185 = "particles/econ/courier/courier_trail_fireworks/courier_trail_fireworks.vpcf",
    Attrib_Particle196 = "particles/econ/courier/courier_shagbark/courier_shagbark_ambient.vpcf",
    Attrib_Particle205 = "particles/econ/courier/courier_roshan_frost/courier_roshan_frost_ambient.vpcf",
    Attrib_Particle206 = "particles/econ/courier/courier_roshan_lava/courier_roshan_lava.vpcf",
    Attrib_Particle268 = "particles/econ/courier/courier_trail_international_2014/courier_international_2014.vpcf",
    Attrib_Particle826 = "particles/econ/seasonal/seasonal_ambient_silver.vpcf",
    Attrib_Particle827 = "particles/econ/seasonal/seasonal_ambient_candy_mint.vpcf",
    Attrib_Particle828 = "particles/econ/seasonal/seasonal_ambient_snow.vpcf",
    Attrib_Particle833 = "particles/econ/seasonal/new_bloom/seasonal_ambient_gold_drop.vpcf",
    Attrib_Particle834 = "particles/econ/seasonal/new_bloom/seasonal_ambient_gold_glow.vpcf",
    Attrib_Particle835 = "particles/econ/seasonal/new_bloom/seasonal_ambient_smoke.vpcf",
    Attrib_Particle836 = "particles/econ/seasonal/crownfall/seasonal_ambient_screeauk.vpcf",
    Attrib_Particle837 = "particles/econ/seasonal/crownfall/seasonal_ambient_screeauk_v2.vpcf",
}
        ...
        elseif item.prefab == "default_item" and used_by_heroes then
            ...
            for heroname, activated in pairs(used_by_heroes) do
                if activated == 1 then
                    ...
                    Wearable.default_items[itemDef] = true
                end
            end
        end
    end
...
function Wearable:TakeOffSlot(hUnit, sSlotName)
    ...
    if hUnit.Slots[sSlotName] then
        ...
        if hUnit.Slots[sSlotName]["seasonal_ethereals"] then
            for sEtherealName, old_p_index in pairs(hUnit.Slots[sSlotName]["seasonal_ethereals"]) do
                ParticleManager:DestroyParticle(old_p_index, true)
                ParticleManager:ReleaseParticleIndex(old_p_index)
                hUnit.Slots[sSlotName]["seasonal_ethereals"][sEtherealName] = nil
            end
        end
...
function Wearable:WearAfterRespawn(hUnit, hNewWears)
    ...
    if hUnit.prismatic then
        Wearable:SwitchPrismaticColor(hUnit, hUnit.prismatic, hUnit.sPrismaticName)
    end
    ...
    if hUnit.ethereals then
        for sEtherealName, old_p_index in pairs(hUnit.ethereals) do
            if old_p_index ~= false then
                ...
                if hUnit.prismatic and Wearable:CanPrismatic(particle_name, hUnit.sPrismaticName) then
                    local vColor = hUnit.prismatic
...
function Wearable:_WearItemsRespawn(hUnitOrigin, hNewWears)
    ...
    CreateUnitByNameAsync(
        ...
        function(hUnitNew)
			...
			hUnitNew.sPrismaticName = hUnitOrigin.sPrismaticName
...
function Wearable:PrecacheAsync(sItemDef, callback)
    PrecacheUnitFromTableAsync({
        MapUnitName = "npc_dota_unit_antimage",
        vscripts = "PrecacheUnit.lua",
        targetname = sItemDef,
    }, function(precacheId)
        callback(precacheId)
    end)
...
function Wearable:Precache(sItemDef, context)
    local itemData = Wearable.items[sItemDef]
    local model_player = itemData.model_player
    if model_player then
        PrecacheResource("model", model_player, context)
    end

    if itemData.visuals and itemData.visuals.styles then
        for style, style_table in pairs(itemData.visuals.styles) do
    ...
    local asset_modifiers = Wearable.asset_modifier[sItemDef]
    print("Wearable:Precache", sItemDef)
    if asset_modifiers then
        for am_name, am_table in pairs(asset_modifiers) do
            if type(am_table) == "table" then
                if am_table.type == "particle_create"
                    or am_table.type == "particle_replace"
                then
                    PrecacheResource("particle", am_table.modifier, context)
                elseif am_table.type == "courier"
                    or am_table.type == "courier_flying"
                    or am_table.type == "entity_model"
                    or am_table.type == "model"
                    or am_table.type == "hero_model_change"
                then
                    PrecacheResource("model", am_table.modifier, context)
                elseif am_table.type == "additional_wearable" then
                    PrecacheResource("model", am_table.asset, context)
                end
            end
        end
    end
...
function Wearable:_WearProp(hUnit, sItemDef, sSlotName, sStyle)
    ...
    if sModel_player then
        ...
        local hModel = SpawnEntityFromTableSynchronous(
            sPropClass,
            {
                targetname = "econ_item_" .. sItemDef,
                model = sModel_player,
    ...
    if asset_modifiers then
        ...
        for _, am_table in pairs(asset_modifiers) do
            ...
            elseif type(am_table) == "table" and am_table.type == "particle_replace" then
                print("particle_replace", am_table.modifier)
                -- 替换其他饰品的周身特效
                if ((not am_table.style) or tostring(am_table.style) == sStyle) and (not am_table.spawn_in_loadout_only) then
                    ...
                    for sSubSlotName, hSubWear in pairs(hUnit.Slots) do
                        print("CheckWearForReplaceParticle", sSubSlotName, hSubWear)
                        for p_name, sub_p in pairs(hSubWear["particles"]) do

                            printf(string.format("Comparing %s and %s", default_particle_name, p_name))
                            if default_particle_name == p_name then
                                printf("Found particle to replace:", p_name)
                                if sub_p ~= false then
                                    printf(string.format("Destroying old particle %s", p_name))
                    ...
                    if has_old_particle then
                        print("AddParticle", particle_name)
...
function Wearable:Wear(hUnit, sItemDef, sStyle)
    Wearable:PrecacheAsync(sItemDef, function(precacheId)
        -- print("WearAfterPrecache", sItemDef, precacheId)
        Wearable:WearAfterPrecache(hUnit, sItemDef, sStyle)
    end)
end

function Wearable:WearAfterPrecache(hUnit, sItemDef, sStyle)
    if type(sItemDef) ~= "string" then
        sItemDef = tostring(sItemDef)
    end
    ...
    if not hUnit.bPersona and (Wearable:IsPersona(sSlotName)) and (sSlotName ~= "persona_selector") then
        return
    end
...
function Wearable:WearCourier(hUnit, sItemDef, sStyle, bFlying, bDire)
    Wearable:PrecacheAsync(sItemDef, function(precacheId)
		Wearable:WearCourierAfterPrecache(hUnit, sItemDef, sStyle, bFlying, bDire)
    end)
end

function Wearable:WearCourierAfterPrecache(hUnit, sItemDef, sStyle, bFlying, bDire)
    print("WearCourierAfterPrecache", hUnit, sItemDef, sStyle, type(sItemDef), type(sStyle), bFlying, bDire)
    local hItem = Wearable.items[sItemDef]
    ...
    if hUnit["particles"] then
        for p_name, p_array in pairs(hUnit["particles"]) do
			for _, p in ipairs(p_array) do
				ParticleManager:DestroyParticle(p, true)
				ParticleManager:ReleaseParticleIndex(p)
			end
            
            if hUnit["prismatic_particles"] and hUnit["prismatic_particles"][p_name] then
                hUnit["prismatic_particles"][p_name] = {}
            end
            hUnit["particles"][p_name] = {}
        end
    end
                ...
                if ((not am_table.style) or tostring(am_table.style) == sStyle) then
                    if (not am_table.flying_courier_only) or bFlying then
                        if ((not am_table.radiant_only) or (not bDire)) and ((not am_table.dire_only) or bDire) then
                            ...
                            hUnit.particles[particle_name] = hUnit.particles[particle_name] or {}
                            table.insert(hUnit.particles[particle_name], p)
                        end
                    end
                end
            end
...
function Wearable:WearWard(hUnit, sItemDef, sStyle)
	Wearable:PrecacheAsync(sItemDef, function(precacheId)
		Wearable:WearWardAfterPrecache(hUnit, sItemDef, sStyle)
	end)
end

function Wearable:WearWardAfterPrecache(hUnit, sItemDef, sStyle)
    print("WearWardAfterPrecache", hUnit, sItemDef, sStyle)
    local hItem = Wearable.items[sItemDef]
...
function Wearable:AddParticle(hUnit, hWear, particle_name, sSlotName, sStyle)
        ...
        for _cpi, cp_table in pairs(cps) do
            if (not cp_table.style) or tostring(cp_table.style) == sStyle then
                ...
                if attach_type == "vector" then
                    ...
                    attach_type = attach_map[attach_type] or PATTACH_POINT_FOLLOW
    ...
    if PrismaticParticles[particle_name] then
        ...
        hUnit["prismatic_particles"][particle_name] = hUnit["prismatic_particles"][particle_name] or {}
        
        -- 支持多个同名粒子，添加到数组中
        table.insert(hUnit["prismatic_particles"][particle_name], {
            particle_index = p,
            slot_name = sSlotName,
            style = sStyle
        })
...
function Wearable:SwitchPrismatic(hUnit, sPrismaticName)
	...
	Wearable:SwitchPrismaticColor(hUnit, vColor, sPrismaticName)
end

function Wearable:SwitchRGBPrismatic(hUnit, rgb)
    print("SwitchRGBPrismatic", hUnit.rgb, rgb, rgb.r, rgb.g, rgb.b)
	local vColor = Vector(rgb.r, rgb.g, rgb.b)
	Wearable:SwitchPrismaticColor(hUnit, vColor, "RGBPrismaticItem")
end

function Wearable:SwitchPrismaticColor(hUnit, vColor, sPrismaticName)
    print("SwitchPrismaticColor", hUnit.rgb, vColor, vColor.x, vColor.y, vColor.z)
    ...
    hUnit.prismatic = vColor
	hUnit.sPrismaticName = sPrismaticName

    if hUnit["prismatic_particles"] then
        for particle_name, p_tables in pairs(hUnit["prismatic_particles"]) do
            local pTablesCopy = {}
            for i, pTable in ipairs(p_tables) do
                table.insert(pTablesCopy, pTable)
            end
            hUnit["prismatic_particles"][particle_name] = {}

            for i, pTable in ipairs(pTablesCopy) do
                if not pTable.hidden then
                    local particle_index = pTable.particle_index
                    local sSlotName = pTable.slot_name
                    local sStyle = pTable.style
                    local hWear = nil
                    if hUnit.Slots then
                    ...
                    pTable.particle_index = new_p_index
                    if hWear then
                    ...
                    if sEtherealName then
                        ...
                        hUnit.ethereals[sEtherealName] = hUnit.ethereals[sEtherealName] or {}
                        for k, p_index in ipairs(hUnit.ethereals[sEtherealName]) do
                            if p_index == particle_index then
                                hUnit.ethereals[sEtherealName][k] = new_p_index
                                break
                            end
                        end
                    end
...
function Wearable:RemovePrismatic(hUnit)
    ...
    hUnit.prismatic = nil
	hUnit.sPrismaticName = nil

    if hUnit["prismatic_particles"] then
        for particle_name, pTables in pairs(hUnit["prismatic_particles"]) do
            local pTablesCopy = {}
            for i, pTable in ipairs(pTables) do
                table.insert(pTablesCopy, pTable)
            end
			hUnit["prismatic_particles"][particle_name] = {}
...
local function IsSeasonalParticle(particleName)
    return string.sub(particleName, 1, 23) == "particles/econ/seasonal"
end

local function IsDefaultItem(sItemDef)
    return Wearable.default_items[sItemDef]
end

-- 添加虚灵宝石（支持同名叠加）
function Wearable:AddEthereal(hUnit, sEtherealName)
    print("AddEthereal", hUnit, sEtherealName)
    hUnit.ethereals = hUnit.ethereals or {}
    hUnit.ethereals[sEtherealName] = hUnit.ethereals[sEtherealName] or {}
    
    local particleName = EtherealParticles[sEtherealName]
    local bIsSeasonal = IsSeasonalParticle(particleName)
    
    if not bIsSeasonal then
        local p = Wearable:AddParticle(hUnit, nil, particleName, nil, "0")
        if hUnit.prismatic and Wearable:CanPrismatic(particleName, hUnit.sPrismaticName) then
            local vColor = hUnit.prismatic
            ParticleManager:SetParticleControl(p, 16, Vector(1, 0, 0))
            ParticleManager:SetParticleControl(p, 15, vColor)
        end
        table.insert(hUnit.ethereals[sEtherealName], p)
    else
        if (not hUnit.Slots) and (hUnit:GetUnitName() ~= "npc_dota_courier_creature") then
            return
        end
        ...
        if hUnit.Slots then
            for sSlotName, hWear in pairs(hUnit.Slots) do
                local model = hWear["model"]
                if model and (not IsDefaultItem(hWear["itemDef"])) then
                    hWear["seasonal_ethereals"] = hWear["seasonal_ethereals"] or {}
                    hWear["seasonal_ethereals"][sEtherealName] = hWear["seasonal_ethereals"][sEtherealName] or {}
                    local p = ParticleManager:CreateParticle(particleName, PATTACH_ABSORIGIN_FOLLOW, model)
                    table.insert(hWear["seasonal_ethereals"][sEtherealName], p)
                    table.insert(particles, p)
                end
            end
        else
            local p = ParticleManager:CreateParticle(particleName, PATTACH_ABSORIGIN_FOLLOW, hUnit)
            table.insert(particles, p)
        end
        table.insert(hUnit.ethereals[sEtherealName], particles)
    end
...
-- 清空虚灵宝石
function Wearable:ClearEthereal(hUnit, sEtherealName)
    print("ClearEthereal", hUnit, sEtherealName)
    if not hUnit.ethereals or not hUnit.ethereals[sEtherealName] then
        return
    end
    ...
    if not bIsSeasonal then
        for _, p_index in ipairs(hUnit.ethereals[sEtherealName]) do
            if p_index and p_index ~= false then
                ParticleManager:DestroyParticle(p_index, true)
                ParticleManager:ReleaseParticleIndex(p_index)
            end
        end
        if hUnit["prismatic_particles"] then
            hUnit["prismatic_particles"][particleName] = nil
        end
    else
        if hUnit.Slots then
            for sSlotName, hWear in pairs(hUnit.Slots) do
                if hWear["seasonal_ethereals"] and hWear["seasonal_ethereals"][sEtherealName] then
                    for _, p_index in ipairs(hWear["seasonal_ethereals"][sEtherealName]) do
                        if p_index then
                            ParticleManager:DestroyParticle(p_index, true)
                            ParticleManager:ReleaseParticleIndex(p_index)
                        end
                    end
                    hWear["seasonal_ethereals"][sEtherealName] = {}
                end
            end
        else
            for _, particleGroup in ipairs(hUnit.ethereals[sEtherealName]) do
				for _, p in ipairs(particleGroup) do
...
function Wearable:ResetGems(hUnit)
    ...
    for sEtherealName, ps in pairs(hUnit.ethereals) do
		Wearable:ClearEthereal(hUnit, sEtherealName)
    end
...
function Wearable:SpecialFixAnim(hUnit, sItemDef)
    ...
    elseif sItemDef == "14900" then
        -- 先知大漠奇花
        return "ACT_DOTA_IDLE"
    elseif sItemDef == "23768" then
        return "ACT_DOTA_IDLE"
    elseif sItemDef == "14960" or sItemDef == "19023" then
        -- 修复潮汐背部不朽
        return "ACT_DOTA_IDLE"
    elseif sItemDef == "29215" then
        return "ACT_DOTA_IDLE"
    elseif sItemDef == "28219" then
        return "ACT_DOTA_IDLE"
    end
    return nil
end
